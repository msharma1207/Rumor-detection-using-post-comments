...
with open('encoded pl/label_pl_final','rb') as f2: label = pickle.load(f2)
...
with open('encoded pl/unencoded_train_cmt_pl','rb') as f4: train_cmt = pickle.load(f4) 
with open('encoded pl/unencoded_test_cmt_pl','rb') as f5: test_cmt = pickle.load(f5)

y_train = label[:len(train_cmt)]
y_test = label[len(train_cmt)+1:]
...
import pickle
with open('encoded pl/encoded_train_post_pl','rb') as f: train_post_enc = pickle.load(f) 
with open('encoded pl/encoded_test_post_pl','rb') as f1: test_post_enc = pickle.load(f1)
